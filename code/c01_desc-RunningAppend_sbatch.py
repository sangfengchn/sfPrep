'''
 # @ Author: feng
 # @ Create Time: 2023-04-30 11:28:15
 # @ Modified by: feng
 # @ Modified time: 2023-04-30 11:28:17
 # @ Description: Running uncomplate preprocessing.
 '''
...
if __name__ == "__main__":
    ...
    if not os.path.exists(opj(subLogPath, "running")): exit
    if not os.path.exists(opj(subOutPath, "net")): exit
    
    try:
        # if not os.path.exists(opj(subOutPath, "dwi", "5ttgmwmiInDwi.nii.gz")):
        #     func_Preprocessing(
